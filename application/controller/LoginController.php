...
class LoginController extends Controller
{
    ...
    public function login()
    {
        ...
        // check login status: if true, then redirect user to main dashboard (dashboard/index), if false, then to login form again
        if ($login_successful) {
			/*
    ...
    public function verifyPasswordReset($user_email, $verification_code)	
    {
        ...
        if (PasswordResetModel::verifyPasswordReset($user_email, $verification_code)) {
...
*/
        PasswordResetModel::setNewPassword(
            Request::post('user_email'), Request::post('user_password_reset_hash'),
            Request::post('user_password_new'), Request::post('user_password_repeat')
        );		
