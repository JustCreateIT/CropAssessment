					...
					<table class="data-table">
						...
						foreach ($this->sample_info as $sample_info) { ?>
							<tr>
								...
								<td style="padding:0px; margin:0px; width:55px;"><input type="number" step=0.01 min=1 name="sample_bulb_weight[]" id="sample_bulb_weight_<?= $index; ?>" required></td>
								...
								<td class="col-last">
									<input type="text" name="sample_comment[]" id="sample_comment_<?= $index; ?>" class="data-table" placeholder="e.g. Disease, Quality">
								</td>
							</tr>
						<?php 
						$index++;
