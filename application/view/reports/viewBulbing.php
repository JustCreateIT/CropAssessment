...
<div class="container">
    ...
    <h1>Bulbing Assessment Report<span style="float:right;"><input type="submit" value="Save As PDF" name="assessment" id="save_pdf_image" title="Save PDF" class="imgPDF" /></span>
